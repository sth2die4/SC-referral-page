...
const i18n = {
  de: {
    ...
    trust4Val: '50.000 UEC', trust4Lbl: 'sofortiger In-Game Bonus',
    // Gallery
    ...
    shipsNote: '💡 Bereits ab dem günstigsten Pack erhältst du den vollen 50.000 UEC Bonus.',
    // Header
    ...
    bonusAmount: '50.000 UEC',
    bonusDesc: 'United Earth Credits — In-Game-Währung für deinen ersten Einkauf im Verse',
    ...
    step3Desc: 'Lade den Launcher herunter, logge dich ein und dein Bonus-UEC erscheint automatisch in deinem Konto.',
    ...
    faq1A: 'Beim Registrieren über den Referral-Link wird der Code STAR-VJ67-N2YG automatisch eingetragen. Nach dem Kauf eines Spielpakets werden dir 50.000 UEC gutgeschrieben — eine In-Game-Währung, die du direkt zum Kaufen von Ausrüstung nutzen kannst. Dank einer 24-Stunden-Nachfrist kannst du den Code auch kurz nach der Account-Erstellung noch nachtragen.',
    ...
    faq3A: 'Die 50.000 UEC werden deinem RSI-Konto nach dem Kauf eines qualifizierenden Pakets gutgeschrieben. In der Regel erscheint der Bonus innerhalb weniger Minuten nach dem Kauf in deinem Konto.',
    ...
    faq6A: 'Star Citizen befindet sich offiziell noch in der Alpha-Phase, ist aber schon voll spielbar. Es gibt noch kein offizielles Release-Datum für den 1.0-Release. Cloud Imperium Games veröffentlicht regelmäßig neue Patches — im Jahr 2026 ist Star Citizen so poliert wie nie zuvor.',
    ...
    // Guide sections
    guideTag: 'Einsteiger Guide 2026',
    ...
    footerCopy: '© 2026 — Inoffizielle Star Citizen Referral Seite · Stand: Juni 2026',
    // Toast
  ...
  en: {
    ...
    trust4Val: '50,000 UEC', trust4Lbl: 'instant in-game bonus',
    ...
    shipsNote: '💡 Even the cheapest pack qualifies you for the full 50,000 UEC bonus.',
    ...
    bonusAmount: '50,000 UEC',
    bonusDesc: 'United Earth Credits — in-game currency for your first purchases in the Verse',
    ...
    step3Desc: 'Download the launcher, log in, and your bonus UEC will appear automatically in your account.',
    ...
    faq1A: 'When you register via the referral link, the code STAR-VJ67-N2YG is automatically applied. After purchasing any game package, 50,000 UEC are credited to your account — in-game currency you can use immediately to buy equipment. Thanks to a 24-hour grace period, you can even add the code shortly after creating your account.',
    ...
    faq3A: 'The 50,000 UEC are credited to your RSI account after purchasing a qualifying package. The bonus typically appears within a few minutes of your purchase.',
    ...
    faq6A: 'Star Citizen is officially still in Alpha but is fully playable. There is no official release date for 1.0 yet. Cloud Imperium Games releases regular patches — in 2026 Star Citizen is more polished than ever.',
    ...
    footerCopy: '© 2026 — Unofficial Star Citizen Referral Site · Updated: June 2026',
  ...
  fr: {
    ...
    trust4Val: '50 000 UEC', trust4Lbl: 'bonus instantané en jeu',
    ...
    shipsNote: '💡 Même le pack le moins cher te qualifie pour le bonus complet de 50 000 UEC.',
    ...
    bonusAmount: '50 000 UEC',
    bonusDesc: "United Earth Credits — monnaie du jeu pour tes premiers achats dans le Verse",
    ...
    step3Desc: "Télécharge le launcher, connecte-toi et tes UEC bonus apparaîtront automatiquement.",
    ...
    faq1A: 'Lors de l\'inscription via le lien de parrainage, le code STAR-VJ67-N2YG est appliqué automatiquement. Après l\'achat d\'un pack, 50 000 UEC sont crédités sur ton compte. Grâce à un délai de 24 heures, tu peux même ajouter le code peu après la création de ton compte.',
    ...
    faq3A: 'Les 50 000 UEC sont crédités sur ton compte RSI après l\'achat d\'un pack éligible, généralement en quelques minutes.',
    ...
    faq6A: 'Star Citizen est officiellement encore en Alpha mais est entièrement jouable. Il n\'y a pas encore de date de sortie officielle pour la version 1.0. Cloud Imperium Games publie régulièrement de nouveaux correctifs — en 2026, Star Citizen est plus poli que jamais.',
    ...
    footerCopy: '© 2026 — Site de Parrainage Star Citizen Non Officiel · Mis à jour : juin 2026',
  ...
  es: {
    ...
    trust4Val: '50.000 UEC', trust4Lbl: 'bono instantáneo en el juego',
    ...
    shipsNote: '💡 Incluso el paquete más barato te califica para el bono completo de 50.000 UEC.',
    ...
    bonusAmount: '50.000 UEC',
    bonusDesc: 'United Earth Credits — moneda del juego para tus primeras compras en el Verse',
    ...
    step3Desc: 'Descarga el launcher, inicia sesión y tu UEC de bono aparecerá automáticamente en tu cuenta.',
    ...
    faq1A: 'Al registrarte a través del enlace de referido, el código STAR-VJ67-N2YG se aplica automáticamente. Tras comprar cualquier paquete de juego, se acreditan 50.000 UEC en tu cuenta. Gracias a un margen de 24 horas, puedes añadir el código incluso poco después de crear tu cuenta.',
    ...
    faq3A: 'Los 50.000 UEC se acreditan en tu cuenta RSI tras la compra de un paquete calificado, generalmente en pocos minutos.',
    ...
    faq6A: 'Star Citizen está oficialmente en Alpha pero es completamente jugable. Aún no hay fecha oficial de lanzamiento para la versión 1.0. Cloud Imperium Games publica parches regulares — en 2026, Star Citizen está más pulido que nunca.',
    ...
    // Guide sections
    guideTag: 'Guía para Principiantes 2026',
    ...
    footerCopy: '© 2026 — Sitio de Referido No Oficial de Star Citizen · Actualizado: junio 2026',
  ...
  it: {
    ...
    trust4Val: '50.000 UEC', trust4Lbl: 'bonus in-game istantaneo',
    ...
    bonusAmount: '50.000 UEC',
    bonusDesc: 'United Earth Credits — valuta in-game per i tuoi primi acquisti nel Verse',
    ...
    step3Desc: 'Scarica il launcher, accedi e il tuo bonus UEC apparirà automaticamente nel tuo account.',
    ...
    shipsNote: '💡 Anche il pacchetto più economico ti qualifica per il bonus completo di 50.000 UEC.',
    faqTag: 'Domande Frequenti',
    faqTitle: 'Tutto quello che devi sapere',
    faq1Q: 'Come funziona il codice referral?',
    faq1A: 'Quando ti registri tramite il link referral, il codice STAR-VJ67-N2YG viene applicato automaticamente. Dopo l\'acquisto di un pacchetto, 50.000 UEC vengono accreditati sul tuo account. Grazie a una finestra di 24 ore, puoi aggiungere il codice anche poco dopo la creazione dell\'account.',
    ...
    faq3A: 'I 50.000 UEC vengono accreditati sul tuo account RSI dopo l\'acquisto di un pacchetto qualificato, di solito entro pochi minuti.',
    ...
    faq6A: 'Star Citizen è ufficialmente ancora in Alpha ma è completamente giocabile. Non c\'è ancora una data di uscita ufficiale per la versione 1.0. Cloud Imperium Games pubblica patch regolari — nel 2026 Star Citizen è più rifinito che mai.',
    ...
    // Guide sections
    guideTag: 'Guida per Principianti 2026',
    ...
    footerCopy: '© 2026 — Sito Referral Star Citizen Non Ufficiale · Aggiornato: giugno 2026',
  ...
  pt: {
    ...
    trust4Val: '50.000 UEC', trust4Lbl: 'bônus instantâneo no jogo',
    ...
    bonusAmount: '50.000 UEC',
    bonusDesc: 'United Earth Credits — moeda do jogo para suas primeiras compras no Verse',
    ...
    step3Desc: 'Baixe o launcher, faça login e seu UEC de bônus aparecerá automaticamente em sua conta.',
    ...
    shipsNote: '💡 Mesmo o pacote mais barato qualifica você para o bônus completo de 50.000 UEC.',
    faqTag: 'Perguntas Frequentes',
    faqTitle: 'Tudo o que você precisa saber',
    faq1Q: 'Como funciona o código de referência?',
    faq1A: 'Ao se registrar pelo link de referência, o código STAR-VJ67-N2YG é aplicado automaticamente. Após comprar qualquer pacote de jogo, 50.000 UEC são creditados em sua conta. Graças a um prazo de 24 horas, você pode adicionar o código mesmo logo após criar sua conta.',
    ...
    faq3A: 'Os 50.000 UEC são creditados em sua conta RSI após a compra de um pacote qualificado, geralmente em poucos minutos.',
    ...
    faq6A: 'Star Citizen está oficialmente ainda em Alpha mas é completamente jogável. Ainda não há data de lançamento oficial para a versão 1.0. A Cloud Imperium Games lança patches regulares — em 2026, Star Citizen está mais polido do que nunca.',
    ...
    // Guide sections
    guideTag: 'Guia para Iniciantes 2026',
    ...
    footerCopy: '© 2026 — Site de Referência Star Citizen Não Oficial · Atualizado: junho 2026',
    toastCopied: '✓ Código copiado!',
...
function renderPage() {
  ...
  // Guide sections
  set('guide-tag', t('guideTag') || 'Einsteiger Guide 2026');
